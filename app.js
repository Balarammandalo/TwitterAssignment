...
// let authoticationToken = (request, response, next) => {
...
//   } else {
//     jwt.verify(jwtToken, 'balarammandalo', async (error, payload) => {
//       if (error) {
//         response.status(401)
//         response.send('Invalid JWT Token')
//       } else {
...
//     `
//   let dbUser = await db.all(generateQuery)
//   if (dbUser === undefined) {
